...
function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Ajay Baghel.</span> An aspiring{" "}
        <span className="font-bold">software engineer</span> with{" "}
        <span className="font-bold">
          knowledge in software engineering practices.
        </span>{" "}
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/ajay-baghel-812747202/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        <a
          className="bg-white p-4 text-gray-900 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://github.com/ajaybaghel1191"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
